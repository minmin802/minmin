...
""")
        ...
        self.assertAlmostEqual(placedb.modelSize("LUT6X").product(), 1.0 / 8)
        self.assertAlmostEqual(placedb.modelSize("F7MUX").product(), 1.0 / 8)
        self.assertAlmostEqual(placedb.modelSize("F8MUX").product(), 1.0 / 8)
        self.assertAlmostEqual(placedb.modelSize("SEQ").product(), 1.0 / 16)
        self.assertAlmostEqual(placedb.modelSize("CARRY4").product(), 1.0)
        self.assertAlmostEqual(placedb.modelSize("DSP1").product(), 2.5)
        self.assertAlmostEqual(placedb.modelSize("DRAM").product(), 5.0)
        self.assertAlmostEqual(placedb.modelSize("RAMA").product(), 5.0)
        self.assertAlmostEqual(placedb.modelSize("RAMB").product(), 5.0)
        ...
        for inst_id in range(placedb.numInsts()):
            ...
            if model.name() in [
                    "LUT1", "LUT2", "LUT3", "LUT4", "LUT5", "LUT6","LUT6X", "F7MUX", "F8MUX"
            ]:
                self.assertEqual(inst_area_type,
                                 placedb.resourceAreaTypes("LUT"))
            elif model.name() in ["SEQ"]:
                self.assertEqual(inst_area_type,
                                 placedb.resourceAreaTypes("FF"))
            elif model.name() in ["CARRY4"]:
                self.assertEqual(inst_area_type,
                                 placedb.resourceAreaTypes("CARRY4"))
            elif model.name() in ["DSP1"]:
                self.assertEqual(inst_area_type,
                                 placedb.resourceAreaTypes("DSP1"))
            elif model.name() in ["DRAM"]:
                self.assertEqual(inst_area_type,
                                 placedb.resourceAreaTypes("DRAM"))
            elif model.name() in ["RAMA"]:
                self.assertEqual(inst_area_type,
                                 placedb.resourceAreaTypes("RAMA"))
            elif model.name() in ["RAMB"]:
                self.assertEqual(inst_area_type,
                                 placedb.resourceAreaTypes("RAMB"))
    ...
    def testSample2(self):
        ...
        num_resources = layout.resourceMap().numResources()
        num_area_types = placedb.numAreaTypes()
        self.assertEqual(num_resources, 11)
